...
if [[ $var != 1 ]]
then
	#echo "se fue alv revisar $varOff"
	curl -H "Content-Type: application/json" -X POST   -d '{"sms":"Hay procesos que no se están ejecutando, por favor revisarlos"}' https://4fj5ga6su4.execute-api.us-east-1.amazonaws.com/default/bnkmonitapps
#else
